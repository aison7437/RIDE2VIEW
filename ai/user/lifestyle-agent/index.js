 ...
 * 6. Attach normalized compatibility signals
...
function detectIntent(context) {
  ...
  const wantsMobility =
    /\btransport\b|\btransportation\b|\bmobility\b|\bget me there\b|\bget there\b|\bride\b|\btaxi\b|\bdriver\b|\bviewing ride\b/i
      .test(searchText);

  const wantsProperty =
    /\bproperty\b|\bhouse\b|\bhome\b|\bapartment\b|\baccommodation\b|\brent\b|\bhousing\b|\bvilla\b|\bmansion\b|\bstudio\b/i
      .test(searchText)
...
function propertyMatchesIntent(
  ...
  /*
   * FIX:
   * Build a valid string using template literals.
   */
...
async function discoverOpportunities(
   ...
   *
   * Student, premium, bedroom and
   * neighborhood searches narrow discovery.
   */
