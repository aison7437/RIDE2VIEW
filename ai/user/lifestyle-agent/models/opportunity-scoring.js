 ...
 * 7. Rank opportunities deterministically
 *
 * Ranking hierarchy:
 *
 ...
 *
 * Produces the complete scoring object used by
 * the ranking and recommendation stages.
 */
...
function scoreOpportunity(
  ...
  try {
    ...
    /*
     * Utility failure must never destroy
...
/**
 * Score a collection of opportunities.
 *
 * This function exists because the workflow calls the
 * plural API:
 *
 *     scoreOpportunities(...)
 *
 * It intentionally does NOT rank the opportunities.
 * Ranking remains the responsibility of rankOpportunities().
 */
