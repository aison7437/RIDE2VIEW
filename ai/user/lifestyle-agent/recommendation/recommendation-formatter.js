...
/**
 * Build explanation for an opportunity.
 */
function buildReason(opportunity) {
  ...
  if (
    Array.isArray(opportunity.utilityExplanation) &&
  ...
  if (
    ...
    return opportunity.reasons.join(". ") + ".";
...
function formatRecommendation(
  ...
  const utilityScore =
    opportunity.utilityScore ?? null;

  const utilityLevel =
    opportunity.utilityLevel || null;
...
/**
 * Complete recommendation formatting.
 */
