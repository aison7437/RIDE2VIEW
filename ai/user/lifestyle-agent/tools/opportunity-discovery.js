 ...
 * 5. Support student scenarios
 * 6. Support premium scenarios
 * 7. Support women-only mobility
 * 8. Support bedroom requirements
 * 9. Preserve discovery metadata through the pipeline
 *
 * Export:
 *
 * module.exports = {
...
function formatProperty(
   ...
   * CRITICAL:
   *
   * Explicitly preserve the complete property
   * metadata, especially bedrooms.
   *
   * The scenario tests inspect:
   *
...
async function discoverOpportunities(
  ...
  */
   ...
   *
   * Student, premium, bedroom and neighborhood
   * requests should narrow discovery.
   */
