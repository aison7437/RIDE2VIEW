...
function assertScenario(result, scenario) {
  ...
  if (assertions.maxBudget !== undefined) {
  ...
  if (assertions.bedrooms !== undefined) {
  ...
  if (propertyRecommendations.length > 1) {
  ...
  if (assertions.location === "Westlands") {
  ...
  if (assertions.allowMobility) {
    ...
    if (mobilityRecommendations.length === 0) {
      failures.push(
  ...
  if (assertions.maxViewingTime !== undefined) {
